...
2.  Create a Commercetools payment
    ...
    | custom.fields.isv_token            | Apple Pay payment data              | Yes       | Obtain the base64encode value for 'paymentData' field on a successful session.onpaymentauthorized event for apple Pay                                                                                                                                                          |
